...
avg_days_to_close = avg_days_to_close[['DAYS TO CLOSE', '30-60-90 Days Open Window']]
avg_days_to_close
...
avg_days_to_close_filtered = data.groupby(['CREATION MONTH-DAY', 'CREATION YEAR', 'STATUS', 'SOURCE']).mean()
...
#Drop Unneeded Columns
avg_days_to_close_filtered = avg_days_to_close_filtered[['DAYS TO CLOSE', '30-60-90 Days Open Window']]
avg_days_to_close_filtered

# get the data
citi_avg_filtered_df = avg_days_to_close_filtered
citi_avg_filtered_df_mod = citi_avg_filtered_df[['CREATION MONTH-DAY', 'CREATION YEAR', 'STATUS', 'SOURCE', 'DAYS TO CLOSE', '30-60-90 Days Open Window']]
